package me.sid.smartcropperlib.view;
...
import me.sid.smartcropperlib.R;
...
public class CropImageView extends ImageView {
    ...
    private static final int DEFAULT_LINE_COLOR = 0xFF27C4A5;
    private static final float DEFAULT_LINE_WIDTH = 2; //dp
    private static final int DEFAULT_MASK_ALPHA = 2; // 0 - 255
    private static final int DEFAULT_MAGNIFIER_CROSS_COLOR = 0xFF27C4A5;
    ...
    private static final int DEFAULT_POINT_FILL_ALPHA = 255;
     ...
     * @param bmp 待裁剪图片
     */
    public void setImageToCrop(Bitmap bmp,IvGenericCallback ivGenericCallback) {
        this.callback=ivGenericCallback;
         setImageBitmap(bmp);
